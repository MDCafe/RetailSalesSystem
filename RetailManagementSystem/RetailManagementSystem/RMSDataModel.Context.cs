...
namespace RetailManagementSystem
{
    ...
    public partial class rmsEntitiesconfig : DbContext
    {
        public rmsEntitiesconfig()
            : base("name=rmsEntitiesconfig")
        {
        }
        ...
        public virtual DbSet<SwapDetail> SwapDetails { get; set; }
